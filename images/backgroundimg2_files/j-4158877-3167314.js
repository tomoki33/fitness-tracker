//Generated:2020-12-04 03:06:03// 6-243
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4158877 || '',
    guid: window.ftGUID_4158877 || '',
    confID: window.ftConfID_4158877 || '0',
    ftReturn: window.ftReturn_4158877 || '',
    keyword: window.ftKeyword_4158877 || '',
    ftId: window.ftId_4158877 || '',
    ftImpId: window.ftImp4158877 && window.ftImp4158877.impID || '',
    gdpr: window.ftImp4158877 && window.ftImp4158877.gdpr || '',
    gdpr_consent: window.ftImp4158877 && window.ftImp4158877.gdpr_consent || '',
    gdpr_pd: window.ftImp4158877 && window.ftImp4158877.gdpr_pd || '',
    us_privacy: window.ftImp4158877 && window.ftImp4158877.us_privacy || '',
    campaignID: '115741',
    cID: '120536',
    pID: '4158877',
    creativeID: '3167314',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115741&sid=18330&plc=4158877&num=&adid=&advid=&adsrv=29&btreg=4158877&btadsrv=flashtalking&crt=3167314&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]"
    ],
    clickTags: ['http://servedby.flashtalking.com/click/8/115741;4158877;3167314;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/jp/creativecloud/buy/students.html?sdid=TKZTLFVF&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?187369678-4158877;3167314;',
    centreAd: false,
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/415/4158877/3167314/image/3167314.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/115741;4158877;202;pixel;DV360;DV360FY20EDUBEHCustomIntentJPDSKBAN300x600/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref: 'http://servedby.flashtalking.com/click/8/115741;4158877;3167314;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/jp/creativecloud/buy/students.html?sdid=TKZTLFVF&mv=display',
    divID: 'ftdiv4158877',
    altimgID: 'ftalt4158877',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4158877 && parseInt(window.ftImp4158877.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4158877') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4158877'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4158877").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4158877").style.display = "none";
		    }
		});
	}
}(ft4158877));
